...
def predict(X, w):
    """
    This func is going to tell us what y_hat is. Usually thats a simple expression like y = (weight)* x + bias.

    Since there is no bias value yet, y = X * w
    """
...
def gradient(X, y, w):
    # our derivation already computed the normal equation to express 
